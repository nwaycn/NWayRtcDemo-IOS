...
#import <NWayRtcSDK/CommonTypes.h>
...
-(void)stopCallingUI
{
    ...
    remoteVideoSize = CGSizeMake(0, 0);
    [_remoteVideoView setSize:remoteVideoSize];
    [_remoteVideoView removeFromSuperview];
    //[self willRemoveSubview:_remoteVideoView];
...
- (void)setupCaptureSession
{
    ...
    output.videoSettings = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            [NSNumber numberWithInt: 640], (__bridge id)kCVPixelBufferWidthKey,
                            [NSNumber numberWithInt: 480], (__bridge id)kCVPixelBufferHeightKey,
                            nil];
#endif
...
{
    localVideoSize.width = 640;
    localVideoSize.height = 480;
